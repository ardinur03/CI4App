      ...
      <div class="col-lg-11 col-md-12 col-sm-10">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Tambah Data Rekmed</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <!-- <form action="/poliklinik/rekmed/store" method="POST"> -->
          <?php
          echo form_open('poliklinik/rekmed/store');
          helper('text');
          $kodeRekmed = random_string('alnum', 5)
          ?>
          <?= csrf_field(); ?>
                ...
                <div class="col-3">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="Id_Rekmed" class="form-control" id="kodeRekmed" value="<?= $kodeRekmed ?>" width="50px" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <select name="Id_Pasien" id="kodePas" class="form-control <?= ($validation->hasError('Id_Pasien')) ? 'is-invalid' : ''; ?>" value="<?= old('Id_Pasien'); ?>">
                      ...
                      <?php foreach ($pasien as $s) : ?>
                        <option value="<?= $s['Id_Pasien']; ?>"><?= $s['Id_Pasien'] . " | "  . $s['Nama_Pasien'] ?> </option>
                      <?php endforeach; ?>
                    </select>
                    <div id="dokValidate" class="invalid-feedback">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="Gejala" class="form-control <?= ($validation->hasError('Gejala')) ? 'is-invalid' : ''; ?>" id="gejala" placeholder="Masukan Gejala" value="<?= old('Gejala'); ?>">
                    <div id="dokValidate" class="invalid-feedback">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="Diagnosa" class="form-control <?= ($validation->hasError('Diagnosa')) ? 'is-invalid' : ''; ?>" id="diagnosa" placeholder="Masukan Diagnosa..." value="<?= old('Diagnosa'); ?>">
                    <div id="dokValidate" class="invalid-feedback">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="Terapi" class="form-control <?= ($validation->hasError('Terapi')) ? 'is-invalid' : ''; ?>" id="terapi" placeholder="Masukan Terapi..." value="<?= old('Terapi'); ?>">
                    <div id="dokValidate" class="invalid-feedback">
