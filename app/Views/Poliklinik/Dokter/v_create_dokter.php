    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 md-9">
        ...
        <div class="card card-primary">
          ...
          <?php
          echo form_open('poliklinik/dokter/store');
          helper('text');
          $kode_dokter = random_string('alnum', 3)
          ?>
          <?= csrf_field(); ?>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" name="Id_Dokter" class="form-control" id="kodeDokter" value="<?= $kode_dokter; ?>" readonly>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select name="Id_Spec" id="kodeSpec" aria-describedby="specValidasi" class="form-control">
                    <option value="">No Selected</option>
                    <?php foreach ($spesialis as $d) : ?>
                      <option value="<?= $d['Id_Spec']; ?>"><?= $d['Id_Spec'];  ?> - <?= $d['Spec']; ?></option>
                    <?php endforeach; ?>
                  </select>
                  <!-- <div id="specValidasi" class="invalid-feedback">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" name="Kontak" class="form-control" id="noHp" placeholder="No Hp" min="0"> <br>
                  </div>
